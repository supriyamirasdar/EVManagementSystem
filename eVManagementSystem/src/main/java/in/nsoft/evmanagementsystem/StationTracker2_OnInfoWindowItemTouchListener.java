...
public abstract class StationTracker2_OnInfoWindowItemTouchListener implements OnTouchListener {
    ...
    public StationTracker2_OnInfoWindowItemTouchListener(View view, Drawable bgDrawableNormal, Drawable bgDrawablePressed) {
        this.view = view;
